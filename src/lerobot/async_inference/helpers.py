...
def prepare_raw_observation(
    ...
    # 2. Greps all observation.images.<> keys that the policy expects
    image_keys = [k for k in filter(is_image_key, lerobot_obs) if k in policy_image_features]
...
class RemotePolicyConfig:
    ...
    lerobot_features: dict[str, dict]  # LeRobot dataset feature specification
